...
outdir =  f'{c.stats_base_dir}/o2_rand_hint_power{d}'
...
def o2_rand_hint_power(benchmark, some_extra_args, outdir_b, cpt_id):
...
def run(benchmark_cpt_id):
    ...
    if prerequisite:
        ...
        c.avoid_repeated(o2_rand_hint_power, outdir_b,
