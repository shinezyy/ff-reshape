...
tag = '8k-table-gshare-hist-5-100'
outdir =  f'/work/gem5-results/fanout-pred-{tag}/'

arch = 'RISCV'

def fanout(benchmark, some_extra_args, outdir_b):
    ...
    # sys.exit(0)
    gem5(
            _out=pjoin(outdir_b, 'fanout_out.txt'),
            _err=pjoin(outdir_b, 'fanout_err.txt'),
            *options
            )
...
def run(benchmark):
    ...
    if prerequisite:
        ...
        c.avoid_repeated(fanout, outdir_b,
